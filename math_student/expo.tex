...
\end{theorem}
\begin{proof}
  Without loss of generality, assume that $v=c^t$ for some $c\in A_n$ and some $t>0$.
  ...
  Repeating this argument with the remaining rows shows that $u_1'\lhd u_2' \lhd \dotsb u_l'$, as required.
