...
\usepackage{hyperref,color,ytableau,MnSymbol}
...
In terms of the notation introduced in Section~\ref{sec:defin-using-timed}, we have the following fairly well-known lemma (see e.g., \cite[Prop.~2.26]{kir-trop}).
\begin{lemma}
  \label{lemma:pl}
