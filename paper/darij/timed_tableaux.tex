...
\end{proof}
\begin{remark}
  The proof of Lemma~\ref{lemma:tableau-shape-greene} shows that the supremum in the definition of Greene invariants (Definition~\ref{definition:timed-Greene-invars}) is attained for timed tableaux.
