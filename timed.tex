...
\begin{definition}[Greene's Invariants for Timed Words]
  ...
  Given a word $w\in A_n^\dagger$, its $k$th Greene's invariant $a_k(w)$ is defined to be the maximum possible sum of lengths of a set of $k$ pairwise disjoint row subwords of $w$:
  \begin{multline*}
